; ModuleID = './llvm/test/Bitcode/DIExpression-aggresult.ll.bc'
source_filename = "/Volumes/Data/llvm/test/Bitcode/DIExpression-aggresult.ll"

%class.A = type { i32, i32, i32, i32 }

; Function Attrs: ssp
define void @_Z3fooi(%class.A* sret(%class.A) %agg.result) #0 !dbg !3 {
  call void @llvm.dbg.declare(metadata %class.A* %agg.result, metadata !13, metadata !DIExpression()), !dbg !16
  ret void, !dbg !16
}
...
!3 = distinct !DISubprogram(name: "foo", linkageName: "_Z3fooi", scope: !1, file: !1, line: 4, type: !4, virtualIndex: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0)
...
!16 = !DILocation(line: 9, column: 5, scope: !3)
