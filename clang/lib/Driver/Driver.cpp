...
static bool addSYCLDefaultTriple(Compilation &C,
  ...
  for (const auto &SYCLTriple : SYCLTriples) {
    ...
    if (SYCLTriple.isNVPTX() || SYCLTriple.isAMDGCN() || SYCLTriple.isXilinxFPGA())
      return false;
  }
  ...
  public:
    ...
    void appendLinkDependences(OffloadAction::DeviceDependences &DA) override {
      ...
      for (auto LinkInputEnum : enumerate(DeviceLinkerInputs)) {
        ...
        auto isXilinxFPGA = TT.isXilinxFPGA();
        ...
        // For SPIR-V targets or Xilinx FPGA, force TY_Tempfiletable.
