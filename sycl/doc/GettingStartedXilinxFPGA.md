...
the "Xilinx Vitis 2020.3: All OS installer Single-File Download"
...
```bash
tar zxvf Xilinx_Unified_2020.3_0407_2214.tar.gz
```
...
```bash
Xilinx_Unified_2020.3_0407_2214/xsetup --batch Install --location /opt/xilinx --agree 3rdPartyEULA,WebTalkTerms,XilinxEULA --edition "Vitis Unified Software Platform"
```
and select `Vitis`.
...
example it is possible to use a `2018.3` target platform with Vitis `2020.3`,
