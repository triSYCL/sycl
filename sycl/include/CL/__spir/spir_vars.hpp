...
SYCL_EXTERNAL size_t __spir_ocl_get_global_size(unsigned int dimindx);
SYCL_EXTERNAL size_t __spir_ocl_get_local_size(unsigned int dimindx);
SYCL_EXTERNAL size_t __spir_ocl_get_global_id(unsigned int dimindx);
SYCL_EXTERNAL size_t __spir_ocl_get_local_id(unsigned int dimindx);
SYCL_EXTERNAL size_t __spir_ocl_get_global_offset(unsigned int dimindx);
