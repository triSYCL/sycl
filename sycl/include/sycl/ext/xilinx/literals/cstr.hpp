...
__SYCL_ALWAYS_INLINE constexpr detail::cstr<CharT, charpack...>
...
#else
template <bool, typename> struct StrNumber { using type = detail::cstr<char>; };
#endif
...
template <auto N, typename Base> struct StrNumber<true, number<N, Base>> {
  ...
  using type = detail::concat_t<detail::cstr<char>,
