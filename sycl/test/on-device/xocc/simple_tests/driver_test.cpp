...
// CHECK-PIPELINE_SW_EMU:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "fpga64_sw_emu-xilinx-linux-sycldevice" "-fsycl" "-fsycl-is-device"
...
// CHECK-PIPELINE_SW_EMU-NEXT:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "fpga64_sw_emu-xilinx-linux-sycldevice" "-fsycl" "-fsycl-is-device" {{.*}} "-fsycl-int-header
// CHECK-PIPELINE_SW_EMU-NEXT:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "{{.*}}" {{.*}} "-fsycl" "-fsycl-is-host"
...
// CHECK-PIPELINE_HW_EMU:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "fpga64_hw_emu-xilinx-linux-sycldevice" "-fsycl" "-fsycl-is-device"
...
// CHECK-PIPELINE_HW_EMU-NEXT:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "fpga64_hw_emu-xilinx-linux-sycldevice" "-fsycl" "-fsycl-is-device" {{.*}} "-fsycl-int-header
// CHECK-PIPELINE_HW_EMU-NEXT:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "{{.*}}" {{.*}} "-fsycl" "-fsycl-is-host"
...
// CHECK-PIPELINE_HW:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "fpga64_hw-xilinx-linux-sycldevice" "-fsycl" "-fsycl-is-device"
// CHECK-PIPELINE_HW-NEXT:{{.*}}sycl-xocc" {{.*}} "hw"
// CHECK-PIPELINE_HW-NEXT:{{.*}}clang-offload-wrapper"
// CHECK-PIPELINE_HW-NEXT:{{.*}}llc"
// CHECK-PIPELINE_HW-NEXT:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "fpga64_hw-xilinx-linux-sycldevice" "-fsycl" "-fsycl-is-device" {{.*}} "-fsycl-int-header
// CHECK-PIPELINE_HW-NEXT:{{.*}}clang-{{[0-9]+}}" "-cc1" "-triple" "{{.*}}" {{.*}} "-fsycl" "-fsycl-is-host"
